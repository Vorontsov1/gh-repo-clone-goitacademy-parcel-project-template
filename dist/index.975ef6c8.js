...
var _fetchImages = require("./js/fetch-images");
var _renderGallery = require("./js/render-gallery");
...
function onSearchForm(e) {
    ...
    (0, _fetchImages.fetchImg)(query, page, perPage).then(({ data  })=>{
        if (data.totalHits === 0) imagesNotFound();
        else {
            (0, _renderGallery.renderGallery)(data.hits);
            simpleLightBox = new (0, _simplelightboxDefault.default)(".gallery a").refresh();
            imagesFound(data);
            if (data.totalHits > perPage) loadMore.classList.remove("is-hidden");
        }
...
},{"./css/styles.css":"1CY4s","notiflix":"5WWYd","./js/fetch-images":"6RYkP","./js/render-gallery":"1TOlG","./js/scroll":"55W1t","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"6RYkP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1TOlG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "onTopBtn", ()=>onTopBtn);
...
function onScroll() {
    ...
    if (scrolled > coords) topBtn.classList.add("btn-to-top-visible");
    if (scrolled > coords) topBtn.classList.remove("btn-to-top-visible");
}
function onTopBtn() {
